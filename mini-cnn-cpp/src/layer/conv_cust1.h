#ifndef SRC_LAYER_CONV_CUST1_H_
#define SRC_LAYER_CONV_CUST1_H_

#include <vector>
#include "../layer.h"

class ConvCust1 : public Layer {
 private:
  const int dim_in;
  int dim_out;
 ...
 public:
  ConvCust1(int channel_in, int height_in, int width_in, int channel_out,
